        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Horarios de empleados</h6>
                </div>
                <div class="card-body">
                    <div class="sb-entity-selector" style="max-width:300px;">
                        <form action="employees-schedule.php" method="POST">
                            <div class="form-group">
                                ...
                                <div style="display:inline-block;margin-bottom: 10px; background-color:red;">
                                    <?php 
                    ...
                    <div class="alert alert-info">
                        <i class="bi bi-info-circle-fill"></i> Defina la jornada del empleado seleccionando el día y las horas en las que laborará.
                    </div>
                    ...
                    <div class="sb-content" style="min-height: 500px;">
                        ...
                        ?>
                                <form method="POST" action="employees-schedule.php">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="save_schedule_sbmt" class="btn btn-info"><i class="bi bi-pencil-square"></i> Guardar cambios</button>
                                    </div>
                                </form>
                        <?php
                            }
                                ...
                                {   
                                    ...
                                    ?>
                                        ...
                                        <script type="text/javascript">
                                            swal("Cambio realizado","¡Se realizó con exito el cambio de horario!", "success").then((value) => {}); 
                                        </script>
