            ...
            if(isset($_POST['submit_book_appointment_form']) && $_SERVER['REQUEST_METHOD'] === 'POST')
            {
                ...
                try
                {
                    ...
                    echo "<div class = 'alert alert-success'>";
                        echo "¡Enhorabuena, su orden se ha recibido exitosamente!";
                    echo "</div>";
		...
		<form method="post" id="appointment_form" action="appointment.php">
			...
			<div class="select_services_div tab_reservation" id="services_tab">
				...
				<div class="alert alert-danger" role="alert" style="display: none">
					¡Por favor, elija al menos un servicio!
				</div>
			...
			<div class="select_employee_div tab_reservation" id="employees_tab">
				...
				<div class="alert alert-danger" role="alert" style="display: none">
					¡Por favor, elija al menos un prestador de servicio!
				</div>

				<div class="text_header">
					<span>
						2. Elija un prestador de servicio
					</span>
				</div>
			...
			<div class="select_date_time_div tab_reservation" id="calendar_tab">
		        ...
		        <div class="alert alert-danger" role="alert" style="display: none">
		          ¡Por favor, elija una hora y una fecha!
		        </div>

				<div class="text_header">
					<span>
						3. Elija su hora y fecha
					</span>
				</div>
			...
			<div class="client_details_div tab_reservation" id="client_tab">
                ...
                <div>
                    <div class="form-group colum-row row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="client_last_name" id="client_last_name" class="form-control" placeholder="Apellidos">
							<span class = "invalid-feedback">Campo obligatorio</span>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <input type="text"  name="client_phone_number" id="client_phone_number" class="form-control" placeholder="Número telefónico">
							<span class = "invalid-feedback">Número telefónico invalido</span>
						</div>
                    </div>
			...
			<div style="overflow:auto;padding: 30px 0px;">
    			<div style="float:right;">
    				<input type="hidden" name="submit_book_appointment_form">
      				<button type="button" id="prevBtn"  class="next_prev_buttons" style="background-color: #bbbbbb;"  onclick="nextPrev(-1)">Regresar</button>
